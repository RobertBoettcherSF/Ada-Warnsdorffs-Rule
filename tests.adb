...
begin
   ...
   -- TEST 1 - Functional Correctness (Standard 5x5)
   Put_Line ("TEST 1 - Standard Variant on 5x5 Board");
   Solve_Tour (5, 1, 1, Standard, Grid_5x5, Success);
   Put_Line ("  1.1 Assert algorithm successfully completes tour");
   Assert (Success = True, "Failed to complete 5x5 standard tour");
   Put_Line ("      PASS");
   Put_Line ("  1.2 Assert generated tour sequence is mathematically valid");
   Assert (Is_Valid_Tour (Grid_5x5, 5) = True, "5x5 standard tour contains invalid moves");
   Put_Line ("      PASS");
   ...
   Put_Line ("TEST 3 - Standard Variant on 6x6 Board");
   Solve_Tour (6, 1, 1, Standard, Grid_6x6, Success);
   ...
   Assert (Is_Valid_Tour (Grid_6x6, 6) = True, "6x6 standard tour invalid");
   Put_Line ("      PASS");
   ...
   begin
      Solve_Tour (5, 6, 1, Standard, Grid_5x5, Success);
   ...
   begin
      Solve_Tour (5, 1, 6, Standard, Grid_5x5, Success);
      Assert (False, "Expected Invalid_Start_Position not raised");
   exception
      when Invalid_Start_Position =>
         Put_Line ("      PASS");
   ...
   Solve_Tour (3, 1, 1, Standard, Grid_3x3, Success);
   ...
   Solve_Tour (4, 1, 1, Standard, Grid_4x4, Success);
   ...
   Solve_Tour (1, 1, 1, Standard, Grid_1x1, Success);
